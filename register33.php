          ...
          <div class="card">
            ...
            <div class="form text-center">
              ...
              <div id="customer" class="typeReg" style="display:block">
                <form action="" name="frmMainCustomer" id="frmMainCustomer" method="post">
                  ...
                  <input type="email" id="inputEmail" name="inputEmail" class="form-control" pattern="[a-z0-9._-]+@+(k|K)+(m|M)+(i|I)+(t|T)+(l|L)+.(a|A)+(c|C)+.(t|T)+(h|H)$"
                  ...
                  <button fromaction="signin.php" class="btn btn-lg btn-primary btn-block" type="submit" id="btnSendCustomer">Create your account</button>
                </form>
              </div>

              <div id="shop" class="w3-container typeReg" style="display:none">
                <form method action="" name="frmMainShop" id="frmMainShop" method="post">
                  <label for="name" class="sr-only">Name</label>
                  ...
                  <label for="shopName" class="sr-only">Shop's name</label>
                  <input type="text" id="shopName" name="shopName" class="form-control" pattern="[^'\x22x27x3Cx3Ex7Bx7Dx5Bx5D]{2,}" maxlength="40"
                  ...
                  <input type="text" id="status" value="shop" name="status" class="sr-only" disabled="disabled">
                  <button fromaction="signin.php" class="btn btn-lg btn-primary btn-block" type="submit" name="btnSendShop" id="btnSend">Create your account</button>
                </form>
              </div>
