<?php
   session_start();
      ...
      $msg1 = "INSERT INTO `shopLog`(`shopID`, `Email`, `amount`, `dateandTime`, `Name`) VALUES('$shopID','$myemail', '$amount', '$datetime', '$fullname')";
      $query = mysqli_query($conn,$msg1) or die (mysqli_error($conn));
