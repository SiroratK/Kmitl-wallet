  ...
  <body>
    <div class="container-fluid">
      <div class="row">
        <div class="col">
          <div class="card">
            <form class="form text-center" id="frmReg">
              ...
              <div id="customer" class="typeReg" style="display:block">
                ...
                <input type="text" id="surname" class="form-control" pattern="[a-zA-Z]"
                  title="Surname must contain only character" placeholder="Surname" required>

                <!-- <label for="customerId" class="sr-only">KMITL ID</label>
                <input type="text" id="customerId" class="form-control" pattern="[0-9]{8}$" maxlength="8"
                  title="ID must be 8 digits of number" placeholder="KMITL ID" required> -->
                ...
                <input type="password" id="inputPin" pattern="(?=.*\d)(?=.*[0-9]).{4}" title="PIN code must be 4 digits of number"
              ...
              <div id="shop" class="w3-container typeReg" style="display:none">
                <label for="name" class="sr-only">Name</label>
                <input type="text" id="name" class="form-control" pattern="[a-zA-Z]"
                  title="Name must contain only character" placeholder="Name" required autofocus>
                ...
                <input type="text" id="shopNeme" class="form-control" pattern="[a-zA-Z]"
                  title="Surname must contain only character" placeholder="Shop's name" required>

                <label for="inputEmail" class="sr-only">Email address</label>
                <input type="email" id="inputEmail" pattern="[a-zA-Z]"
                  class="form-control" placeholder="Email address" required>
