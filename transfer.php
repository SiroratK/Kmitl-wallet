        ...
        <div class="col">
          <div class="card">
            <form class="form">
              ...
              <label for="transID" class="sr-only">ID or Username</label>
              <input type="text" id="transID" class="form-control form-control-bottom" placeholder="ID or Username" required autofocus>
              </br>
              <label for="amount" class="sr-only">Amount</label>
              <input type="text" id="amonut" class="form-control form-control-bottom" placeholder="Amount" required>
              </br>
