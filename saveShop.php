<?php
    $passwordInput  =  $_POST["passwordS"];
    $salt      = 'ceKmitlWalleteiei2018';
    $password_hashed    = hash('sha256', $passwordInput . $salt);
    ...
    if ($check == NULL || $check != $_POST["inputEmailS"]){
        ...
        if ($row['shopName'] == NULL || $row['shopName'] != $_POST["shopNameS"]){
            ...
            VALUES ('".$_POST["nameS"]."','".$_POST["surnameS"]."','".$_POST["shopNameS"]."','".$_POST["inputEmailS"]."','$password_hashed',
            $num+1,'Shop',$int,0)";
            ...
            echo json_encode(array('status'=>'0','msg'=>'Username is Already'));
        }
    }
    else {
